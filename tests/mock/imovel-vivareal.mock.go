...
var MockImovelErrorInvalidRentalTotalPrice = protocols.Imovel{
	Usableareas:   40,
	Listingtype:   "list1",
	Createdat:     time.Now(),
...
var MockImovelInvalidMonthlycondofeeValue = protocols.Imovel{
	Usableareas:   150,
	Listingtype:   "list1",
	Createdat:     time.Now(),
	Listingstatus: "active",
...
var MockImovelNotElegibleMonthlycondofeeValue = protocols.Imovel{
	Usableareas:   150,
	Listingtype:   "list1",
	Createdat:     time.Now(),
	Listingstatus: "active",
...
var MockImovelNotElegibleMaxRentalValue = protocols.Imovel{
	Usableareas:   150,
	Listingtype:   "list1",
	Createdat:     time.Now(),
	Listingstatus: "active",
